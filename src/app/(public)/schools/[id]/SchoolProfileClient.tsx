...
/**
 * Interactive half of the school profile. The server component fetches the data
 * and renders the first paint; this handles favouriting, comparing, messaging,
 * reviews, and the map — none of which a crawler needs.
 */
export default function SchoolProfileClient({ school, initialReviews }: Props) {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-border p-6">
              ...
              <div className="space-y-3">
                {[
                  { label: 'Type', value: getSchoolTypesLabel(school.types, school.type) },
